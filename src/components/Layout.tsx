...
import posterImage from 'images/jia.jpg'
    ...
    <svg aria-hidden="true" className="absolute left-0 top-0 h-20 w-full">
      <defs>
        ...
        <linearGradient id={`${id}-gradient`}>
          <stop offset="0%" stopColor="#3AC28E" />
          <stop offset="50%" stopColor="#59DA9A" />
          <stop offset="100%" stopColor="#3AC248" />
        </linearGradient>
        <mask id={`${id}-mask`}>
...
function AboutSection(props) {
  ...
  return (
    <section {...props}>
      <h2 className="flex items-center font-mono text-sm font-medium leading-7 text-neutral-900 dark:text-neutral-200">
      ...
      <p
        className={clsx('mt-2 text-base leading-7 text-neutral-700 dark:text-neutral-300', {
          'lg:line-clamp-4': !isExpanded,
        })}
      >
        In this show, John and others in the community discuss the town of Jackson and ways to help it grow and thrive.
      </p>
      {!isExpanded && (
        <button
          type="button"
...
export function Layout({ children }) {
  return (
    <>
      <div className="bg-neutral-50 dark:bg-neutral-900 lg:fixed lg:inset-y-0 lg:left-0 lg:flex lg:w-112 lg:items-start lg:overflow-y-auto xl:w-120">
        <div className="hidden lg:sticky lg:top-0 lg:flex lg:w-16 lg:flex-none lg:items-center lg:whitespace-nowrap lg:py-12 lg:text-sm lg:leading-7 lg:[writing-mode:vertical-rl]">
          <span className="font-mono text-neutral-400">Hosted by</span>
          <span className="mt-6 flex font-bold text-neutral-900 dark:text-neutral-200">
            <span className="after:mt-6 after:text-neutral-400 after:content-['/']">
              John Weland
            </span>
            {/* <span className="mt-6">Wes Mantooth</span> */}
          </span>
        </div>
        <div className="relative z-10 mx-auto px-4 pb-4 pt-10 sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-neutral-200 dark:lg:border-neutral-700 lg:py-12 lg:px-8 xl:px-12">
          <Link href="/">
            <a
              className="relative mx-auto block w-48 overflow-hidden rounded-lg bg-neutral-200 shadow-xl dark:bg-neutral-700 dark:shadow-neutral-700 shadow-neutral-200 sm:w-64 sm:rounded-xl lg:w-auto lg:rounded-2xl"
              aria-label="Homepage"
            >
              <Image
                src={posterImage}
          ...
          <div className="mt-10 text-center lg:mt-12 lg:text-left">
            <p className="text-xl font-bold text-neutral-900 dark:text-neutral-200">
              <Link href="/">
                <a>Jackson in Action</a>
              </Link>
            </p>
            <p className="mt-3 text-lg font-medium leading-8 text-neutral-700 dark:text-neutral-300">
              Conversations about our little corner of the planet, Jackson Minnesota
            </p>
          </div>
          <AboutSection className="mt-12 hidden lg:block" />
          <section className="mt-10 lg:mt-12">
            <h2 className="sr-only flex items-center font-mono text-sm font-medium leading-7 text-neutral-900 dark:text-neutral-200 lg:not-sr-only">
              <svg aria-hidden="true" className="h-2.5 w-2.5">
                <path
                  d="M0 5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V5Z"
                  className="fill-emerald-300"
            ...
            <div className="h-px bg-gradient-to-r from-neutral-200/0 via-neutral-200 to-neutral-200/0 lg:hidden" />
            <ul className="mt-4 flex justify-center space-x-10 text-base font-medium leading-7 text-neutral-700 dark:text-neutral-200 sm:space-x-8 lg:block lg:space-x-0 lg:space-y-4">
              <li className="flex">
                <Link href="/">
                  <a className="group flex items-center">
                    <svg
                      aria-hidden="true"
                      className="h-8 w-8 fill-neutral-400 group-hover:fill-neutral-600 dark:fill-neutral-200 dark:group-hover:fill-neutral-400"
                    >
      ...
      <div className="border-t border-neutral-200 lg:relative lg:mb-28 lg:ml-112 lg:border-t-0 xl:ml-120">
        <Waveform />
        <div className="relative">{children}</div>
      </div>
      <div className="border-t border-neutral-200 bg-neutral-50 py-10 pb-40 sm:py-16 sm:pb-32 lg:hidden">
        <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4">
          <AboutSection />
          <h2 className="mt-8 flex items-center font-mono text-sm font-medium leading-7 text-neutral-900 dark:text-neutral-200">
            <svg
              aria-hidden="true"
              viewBox="0 0 11 12"
              className="h-3 w-auto fill-neutral-300"
            >
          ...
          <div className="mt-2 flex text-sm font-bold leading-7 text-neutral-900 dark:text-neutral-200">
            <span className="after:ml-6 after:text-neutral-400 after:content-['/']">
              John Weland
            </span>
