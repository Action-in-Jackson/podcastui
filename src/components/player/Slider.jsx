  ...
  return (
    ...
    >
      ...
      <div
        ...
        ref={trackRef}
        className="relative w-full bg-emerald-100 md:rounded-full"
      >
        <div
          className={clsx(
          ...
          style={{
            width:
              state.getThumbValue(0) === 0
                ? 0
                : `calc(${state.getThumbPercent(0) * 100}% - ${isFocusVisible || state.isThumbDragging(0) ? '5px' : '4px'
                })`,
          }}
        />
        <Thumb
      ...
      <div className="hidden items-center gap-2 md:flex">
        ...
        <span className="text-sm leading-6 text-neutral-400 dark:text-neutral-100 ">/</span>
        <span
          className={clsx(
            'hidden rounded-md px-1 py-0.5 font-mono text-sm leading-6 text-neutral-500 dark:text-neutral-300 md:block',
            state.getThumbMaxValue(0) === 0 && 'opacity-0'
          )}
        >
...
function Thumb(props) {
  ...
  return (
    <div
      className="absolute -top-1/2 -tran-neutral-x-1/2"
      style={{
    ...
    >
      <div
        ...
        className={clsx(
          'h-4 w-1 rounded-full bg-neutral-700 dark:bg-neutral-500',
