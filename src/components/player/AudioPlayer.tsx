...
export function AudioPlayer() {
  ...
  return (
    <div className="flex items-center gap-6 bg-white/90 dark:bg-neutral-900 py-4 px-4 shadow shadow-neutral-200/80 ring-1 ring-neutral-900/5 backdrop-blur-sm md:px-6">
