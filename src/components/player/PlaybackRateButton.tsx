...
export function PlaybackRateButton({ player }) {
  ...
  return (
    <button
      type="button"
      className="relative flex h-6 w-6 items-center justify-center rounded-md  dark:text-neutral-500 hover:bg-neutral-100 hover:text-neutral-700 focus:outline-none focus:ring-2 focus:ring-neutral-400 dark:focus:ring-neutral-400 focus:ring-offset-2"
      onClick={() => {
